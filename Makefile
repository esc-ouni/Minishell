...
#    Updated: 2023/06/05 18:52:32 by msamhaou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#********* EXEC *************
EXEC_DIR = EXEC/
EXEC_SRC_FILES = ft_exec.c	ft_env_lst_tools.c  ft_exp_lst_tools.c  ft_export.c  ft_set_env.c  ft_set_exp.c  ft_unset.c ft_free.c ft_msoft_split.c
