...
#    Updated: 2023/06/03 15:10:53 by msamhaou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
all :
	gcc main.c libft.a EXEC/ft_env_lst_tools.c EXEC/ft_exp_lst_tools.c EXEC/ft_set_env.c EXEC/ft_set_exp.c -Iinclude EXEC/ft_exec.c
