...
#    Updated: 2023/06/09 17:13:10 by msamhaou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIBFT_SRC_FILES =	ft_atoi.c         ft_isascii.c      ft_itoa.c         ft_lstdelone.c    ft_lstsize.c      ft_memmove.c      ft_putnbr_fd.c    ft_strdup.c       ft_strlcpy.c      ft_strnstr.c      ft_tolower.c\
					...
					ft_calloc.c       ft_islpha.c       ft_lstadd_front.c ft_lstlast.c      ft_memcmp.c       ft_putchar_fd.c   ft_split.c        ft_strmapi.c      ft_strtrim.c      ft_strdigit.c\
...
PARS_SRC_FILES =	expander.c tools_15.c lexer.c memory.c parser.c syntax.c tools_1.c tools_10.c tools_11.c tools_12.c \
					tools_2.c tools_3.c tools_4.c tools_5.c tools_6.c tools_7.c tools_8.c tools_9.c tools_13.c tools_14.c
